...
const switchTab = (id) => {
  if (id === "posts") {
    ...
    document.getElementById("questinContainer").style.display = "block";
  } else if (id === "liked") {
    document.getElementById("liked").style.display = "block";
    document.getElementById("posts").style.display = "none";
    document.getElementById("reported").style.display = "none";
    document.getElementById("questinContainer").style.display = "none";
